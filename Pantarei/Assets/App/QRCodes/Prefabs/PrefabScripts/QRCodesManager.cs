...
namespace QRTracking
{
    ...
    public class QRCodesManager : Singleton<QRCodesManager>
    {
        ...
        {
            Debug.Log("In QRCodesManager Start");
        ...
        {
            Debug.Log("QRCodesManager starting QRCodeWatcher try to start");
            if (qrTracker == null) throw new Exception(String.Format("No tracker available.\nAccess status:{0}\nCapability: {1}\nIs supported: {1}", accessStatus, capabilityInitialized, IsSupported));
